...
if ($current_user_id != '1') {
  $meta_value_tasks_author = array( 'key' => '_crb_tasks_author', 'value' => $current_user_id, 'compare' => '=');
}
$quotes = [
      ...
      <div class="bg-white rounded mb-4">
        <div class="flex items-center justify-between py-3">
          <div class="top-nav flex items-center gap-x-4 px-4">
            ...
            <div><a href="<?php echo get_page_url("page-accept"); ?>" class="flex items-center bg-red-500 rounded-lg text-gray-100 uppercase font-medium text-sm px-3 py-1">Виконано</a></div>
          </div>
          ...
          <table class="tasks w-full text-sm prott-table">
            <thead class="text-sm border-b border-gray-200 bg-black/80 text-gray-200">
              <tr>
                ...
                <th class="p-2 prott-sort-js" data-sort-type="text" data-sort-id="1">
                ...
                <th class="p-2 prott-sort-js" data-sort-id="2">
                  <div class="flex items-center">
                    <div>📅 Дата</div>
                    <div class="sort-arrow hidden ml-2">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
            ...
            <tbody>
              ...
              ?>
                <?php get_template_part('template-parts/tasks-accept-item-table'); ?>
