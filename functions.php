...
if (!function_exists('tarakan_setup')):
    function tarakan_setup()
    {
        ...
        add_theme_support(
            'custom-background',
            apply_filters('ginfo_custom_background_args', [
...
function crb_load()
{
    ...
    require_once get_template_directory() .
        '/inc/carbon-fields/carbon-fields-plugin.php';
    require_once get_template_directory() .
        '/inc/custom-fields/settings-meta.php';
    ...
    require_once get_template_directory() .
        '/inc/custom-fields/comment-meta.php';
    require_once get_template_directory() . '/inc/custom-fields/user-meta.php';
    require_once get_template_directory() .
        '/inc/custom-fields/gutenberg-blocks.php';
}
...
function itsme_disable_feed()
{
    wp_die(
        __(
            'No feed available, please visit the <a href="' .
                esc_url(home_url('/')) .
                '">homepage</a>!'
        )
    );
...
function tarakan_scripts()
{
    ...
    if (is_post_type_archive('articles')) {
        wp_enqueue_script(
            'articles-export',
            get_template_directory_uri() . '/build/export-articles.js',
            [],
            null,
            true
        );
...
function update_params_field_programmatic()
{
    ...
    foreach ($posts as $post) {
        ...
        if (!metadata_exists('post', $post, '_crb_article_ahrefs_traffic')) {
            update_post_meta($post, '_crb_article_ahrefs_traffic', '');
        }
