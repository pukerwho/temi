      ...
      <div class="bg-white rounded mb-4">
        <div class="flex items-center justify-between py-3">
          <div class="top-nav flex items-center gap-x-4 px-4">
            ...
            <div><a href="<?php echo get_page_url("page-check"); ?>" class="flex items-center bg-red-500 rounded-lg text-gray-100 uppercase font-medium text-sm px-3 py-1">Очікує перевірки</a></div>
        ...
        <div class="py-3 px-4">
          ...
          <table class="tasks w-full text-sm">
            ...
            <tbody>
              ...
              ?>
                <?php get_template_part('template-parts/tasks-check-item-table'); ?>
