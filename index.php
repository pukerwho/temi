  ...
  <div class="mx-auto max-w-7xl rounded-xl bg-white shadow-xl">
    ...
    <div class="flex items-center justify-between border-b p-4">
      ...
      <div class="flex gap-2">
        <div class="tab active flex items-center gap-2 px-3 py-1.5 text-sm font-medium cursor-pointer" data-tab="work">
          <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
          </svg>
          <div>Завдання</div>
        </div>
        <div class="tab flex items-center gap-2 px-3 py-1.5 text-sm font-medium cursor-pointer" data-tab="archive">
          <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
