  ...
  <div class="py-4 px-4">
    <div class="mx-auto max-w-7xl rounded-xl bg-white ">
      ...
      <form  name="filter_tours" method="get">
        <div class="w-full flex items-center py-2 pl-2 pr-4">
        ...
        <div>
            ...
            <input type="text" id="" name="s" value="<?php echo isset($_GET['s']) ? esc_attr($_GET['s']) : ''; ?>" placeholder="Пошук" class="w-full bg-white text-lg outline-none px-4 py-2" />
      ...
      <div class="overflow-x-auto">
        ...
        <?php else: ?>
          <?php get_template_part('template-parts/guest-table'); ?>
        <?php endif; ?>
      </div>
